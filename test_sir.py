...
def test_vaccinate_city(test_params):
    ...
    actual = sir.vaccinate_city(city)

    recreate_msg = ("See the information for Task 10, Test {} to "
                    "see how to recreate this test.")
    recreate_msg = recreate_msg.format(test_num)
...
def test_vaccinate_and_simulate(test_params):
    ...
    actual = sir.vaccinate_and_simulate(city, days_contagious, infection_probability, seed)

    recreate_msg = ("See the information for Task 11, Test {} to "
                    "see how to recreate this test.")
    recreate_msg = recreate_msg.format(test_num)
